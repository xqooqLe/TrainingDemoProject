...
not_run: WebUI.click(findTestObject('Page_OrangeHRM/input_Username_username'))
...
WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_User Management_oxd-icon'))
